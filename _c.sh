...
cur(){ dump; grep -o 'text="音 [0-9]* / [0-9]*"' /tmp/u.xml | head -1; }
...
# twinkle: select then start then skip
tapid home_score_option_twinkle.mxl
tapid home_start
tapid tuning_skip
sleep 3; echo "early: $(cur)"; shot center_early.png
sleep 6; echo "later: $(cur)"; shot center_later.png
